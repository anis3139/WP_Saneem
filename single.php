...
<html lang="en">
  <head>
    <title>Oneder &mdash; Website Template by saneem</title>
    <meta charset="utf-8">
        ...
        <div class="row pt-5 mt-5 text-center">
          <div class="col-md-12">
            <div class="border-top pt-5">
              <p>
            <!-- Link back to saneem can't be removed. Template is licensed under CC BY 3.0. -->
            Copyright &copy;<script>document.write(new Date().getFullYear());</script> All rights reserved | This template is made with <i class="icon-heart text-danger" aria-hidden="true"></i> by <a href="https://saneem.com" target="_blank" >saneem</a>
            <!-- Link back to saneem can't be removed. Template is licensed under CC BY 3.0. -->
            </p>
